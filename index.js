...
const renderDrinkListPage = async () => {
  // Thomas: For now, go ahead and don't worry about the links.
  // Just layout the drink list page on the main welcome page
  // We'll get to linking everything together later.
...
const homePageLinkEvent = () => {
  homePageLink().addEventListener("click", (e) => {
    // Thomas: We're going to work on this later.
    e.preventDefault();
  });
};
